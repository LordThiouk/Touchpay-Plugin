...
class WC_Gateway_TouchPay extends WC_Payment_Gateway {
    ...
    public static function maybe_render_touchpay_page() {
        ...
        echo '  if (typeof TouchPayCheckout === "function") {';
        echo '    TouchPayCheckout({';
        echo '      order_number: "' . $order_number . '",';
        echo '      agency_code: "' . $agency_code . '",';
        echo '      secure_code: "' . $secure_code . '",';
        ...
        echo '      phone: "' . $phone . '",';
        echo '      url_redirection_success: "' . $url_success . '",';
        echo '      url_redirection_failed: "' . $url_failed . '"';
        echo '    });';
        echo '  } else {';
